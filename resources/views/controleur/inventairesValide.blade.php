    ...
    <div class="col-md-12">
      ...
      <div class="box">
        <header class="dark">
          ...
          <h5>Inventaires valide <span class="badge badge-info badge-pill" title="Nombre d'inventaires"> {{ $data->count() }}</span></h5>
          <div class="toolbar">
        ...
        <div id="collapse" class="body">
          ...
          <div class="breadcrumb">
            <h4>Filtre</h4>
            <form id="formFilterInventaires" method="POST" action="{{ route('c.inventairesValide') }}">
              @csrf
              <div class="row">
                <div class="col-sm-3">
                ...
                <div class="col-sm-3">
                  <div class="form-group has-feedback">
                    <input type="date" name="date" id="filter_date" class="form-control" value="{{ $selected_date or '' }}">
                  </div>
                </div>
