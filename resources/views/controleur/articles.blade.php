      ...
      <div class="box">
          ...
          <div class="toolbar">
            <nav style="padding: 8px;">
              ...
              <ul class="dropdown-menu">
                <li><a data-placement="bottom" data-toggle="modal" data-target="#modalAddArticle">Ajouter un article</a></li>
        ...
        <div id="collapse" class="body">
          <div class="breadcrumb">
            <form id="formFilterArticles" method="POST" action="{{ route('c.articles') }}">
              @csrf
              <div class="row">
                <div class="col-lg-4">
                  {{-- Famille --}}
...
@section('modals')
  ...
  <form id="formExportArticles" method="POST" action="{{ route('c.exportArticles') }}" target="_blank">
    @csrf
...
<div class="CRUD Articles">
  <form id="formDeleteArticle" method="POST" action="{{ route('c.deleteArticle') }}">
    @csrf
  ...
  <div class="modal fade" id="modalUpdateArticle" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    {{-- Form update article --}}
    <form method="POST" action="{{ route('c.updateArticle') }}" id="formUpdateArticle">
      @csrf
  ...
  <div class="modal fade" id="modalAddArticle" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <form method="POST" action="{{ route('c.addArticle') }}" id="formAddArticle">
      @csrf
  ...
  <div class="modal fade" id="modalAddArticles" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    {{-- Form upload File --}}
    <form method="POST" action="{{ route('c.addArticles') }}" enctype="multipart/form-data">
      @csrf
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
